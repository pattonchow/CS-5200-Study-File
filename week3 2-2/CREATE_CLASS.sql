...
class YEAR NOT NULL CHECK(class < 2050 AND class > 1900),
...
nu_college(name) ON UPDATE CASCADE ON DELETE SET NULL
);
...
Student(first_name , last_name , 
	...
	date_of_birth , class)    
VALUES 
('Lucy', 'Liu' , "Khoury College of Computer Sciences", 20, 128, '2004-12-22', '2022'),    -- note the date format
('Matt', 'Finn', 'College of Engineering', 24, 128, '2006-07-04', '2022'),    
('Sam', 'Asner', 'Khoury College ot Computer Sciences', 32, 120, '2005-03-14', '2022');

-- students is accepted to nu school
-- many students associated with a school
-- one student is associated with 0 or 1 school

CREATE TABLE nu_college(
name VARCHAR(64) PRIMARY KEY );

INSERT INTO nu_college VALUES
